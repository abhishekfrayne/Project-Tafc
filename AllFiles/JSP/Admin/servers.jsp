...
<p>
	...
	<table id="results" class="tab" border="1" cellpadding="5px" cellspacing="4px" width="550px">
		...
		<tr>
			...
			<font color="#000000" style="font-style: bold;font-family: monotype corsiva" size="6">Cloud Server Details</font>
			</td>
			...
			<table id="login" align="center">
				...
				<input type="hidden" name="add1" value="YES"></input>
					...
					<tr>
							...
							<font color="#000000" style="font-style: bold;font-family: monotype corsiva" size="6">Add Server Details</font>
							</td>
					</tr>
		 ...
		 <p>
			<table id="login" align="center">
			    ...
			    <input type="hidden" name="id" value="<%=id %>"></input>
					...
					<tr>
							<td colspan="3" align="center">
							<font color="#000000" style="font-style: bold;font-family: monotype corsiva" size="6">Edit Server Details</font>
							</td>
					</tr>
