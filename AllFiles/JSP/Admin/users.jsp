...
%>
			<tr align="center">
				<td><input name="chk" type="checkbox" value="<%=id%>"></td>
						...
						<td><%=adminDAO.getDesignationName(deptId2)%></td>
						<td><%=doj%></td>
			...
			<table id="login" align="center">
			    ...
			    <input type="hidden" name="id" value="<%=id %>"></input>
					...
					<tr align="center">
							...
							<td>:</td>
							<td> 
									<input class="field" type="text" name="email" value="<%=email%>" pattern="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" required="yes"></input>
							</td>
					</tr>
					...
					<tr align="center">
							...
							<td>:</td>
							<td> 
									<input class="field" type="text" name="doj" value="<%=address %>" readonly="readonly"></input>
							</td>
