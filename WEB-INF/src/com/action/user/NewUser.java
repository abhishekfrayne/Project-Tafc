			...
			*/
			...
			DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
			   ...
			   FileWriter fstream = new FileWriter(MDKeyFilePath);
		        ...
		        boolean sendMailflag=CL_SendMail.sendPersonalizedMail(email, "deduplication8@gmail.com", "Indian123", "Download Identity Key File", "Identity Tocken", MDKeyFilePath, "smtp.gmail.com", "465",fnm);
