...
public class SecretFile_Decrypt extends HttpServlet
{
		             ...
		             else if ((s.startsWith("Content-Disposition")) && (state == 0))
		             {
			               state = 1;
			                ...
			                else
			                {
				                ...
				                String file_path="C:/SecretKeys/"+fileName;
				          		 
				                key_value = ReadIdentyTocken.readfile(file_path);
				                
				                
				                //Decrypt the File By Using DES Algorithm //
				    			...
				    			String rns_des_key="88tteehh";
				    			
				    			System.out.println("Keys :"+rns_des_key);
				    			
				    			DesEncryption decrypt1=new DesEncryption(rns_des_key);
				    			
				                String decrypt_data=decrypt1.decrypt(key_value);
			    			...
			    			if(flag)
			    			{
			    				...
			    				rd=request.getRequestDispatcher("/AllFiles/JSP/User/upload_file.jsp?no=0");
			    				rd.forward(request,response);
			    			}
			    			else
			    			{
			    				response.sendRedirect("/AllFiles/JSP/User/upload_file.jsp?no=1");
			    			}
